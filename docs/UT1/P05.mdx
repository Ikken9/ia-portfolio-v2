...
<img src={`/${process.env.GITHUB_REPOSITORY.split('/')[1]  + '' || ''}/p05_1.png`} alt="distribuciones" />

<br></br>

### Relaciones Entre Variables
<img src={`/${process.env.GITHUB_REPOSITORY.split('/')[1]  + '' || ''}/p05_2.png`} alt="relaciones" />

<br></br>

### Matriz de Correlación - Mall Customers
<img src={`/${process.env.GITHUB_REPOSITORY.split('/')[1]  + '' || ''}/p05_3.png`} alt="matriz" />
...
<img src={`/${process.env.GITHUB_REPOSITORY.split('/')[1]  + '' || ''}/p05_4.png`} alt="scalers" />
...
<img src={`/${process.env.GITHUB_REPOSITORY.split('/')[1]  + '' || ''}/p05_5.png`} alt="scalers-annual-income" />
...
#### Varianza
<img src={`/${process.env.GITHUB_REPOSITORY.split('/')[1]  + '' || ''}/p05_6.png`} alt="varianza" />

<br></br>

#### Mall Customers en Espacio PCA 2D
<img src={`/${process.env.GITHUB_REPOSITORY.split('/')[1]  + '' || ''}/p05_7.png`} alt="varianza-componentes" />
...
<img src={`/${process.env.GITHUB_REPOSITORY.split('/')[1]  + '' || ''}/p05_8.png`} alt="comparacion" />
...
<img src={`/${process.env.GITHUB_REPOSITORY.split('/')[1]  + '' || ''}/p05_9.png`} alt="elbow-silhouette" />
...
### Clustering
<img src={`/${process.env.GITHUB_REPOSITORY.split('/')[1]  + '' || ''}/p05_10.png`} alt="clustering" />
